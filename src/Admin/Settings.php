	...
	function get_settings_fields()
	{
		$settings_fields = [
			'wpgatsby_settings' => [
				...
				[
					'name' => 'builds_webhook_active',
					'label' => __('Enable Build Webhook?', 'wpgatsby_settings'),
					'desc' => __('Toggle builds on/off. When disabled, the Builds Webhook URL will not be called when changes are made.', 'wpgatsby_settings'),
					'type' => 'checkbox',
					'default' => 'on',
				],
				[
					'name' => 'trigger_build_now',
					'label' => __('Trigger Build Now', 'wpgatsby_settings'),
					'desc' => __('Check this box to trigger a build immediately (will be reset after saving).', 'wpgatsby_settings'),
					'type' => 'checkbox',
				],
			],
		];
